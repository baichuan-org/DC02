...
TEST_CASE("Connect_f2pool_exception", "[stratum]")
{
    StratumApiV1Message stratum_api_v1_message = {};
    const char *json_string = "{\"id\":1,\"result\":[[[\"mining.set_difficulty\",\"mining.set_difficulty\"],[\"mining.notify\",\"mining.notify\"]],\"00006b\",6]}";
    STRATUM_V1_parse(&stratum_api_v1_message, json_string);

    TEST_ASSERT_EQUAL(1, stratum_api_v1_message.message_id);
    TEST_ASSERT_EQUAL(STRATUM_RESULT_SUBSCRIBE, stratum_api_v1_message.method);
}

TEST_CASE("Connect_solo_pool_passed", "[stratum]")
{
    StratumApiV1Message stratum_api_v1_message = {};
    const char *json_string = "{\"result\":[[[\"mining.set_difficulty\",\"0HN9BPP3VG8RN\"],[\"mining.notify\",\"0HN9BPP3VG8RN\"]],\"217cce23\",4],\"error\":null,\"id\":1}";
    STRATUM_V1_parse(&stratum_api_v1_message, json_string);
