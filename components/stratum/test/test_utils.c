...
TEST_CASE("Test_flip32bytes", "[utils]")
{
    uint32_t test_array[8] = {0x12345678, 0x12345678, 0x12345678, 0x12345678, 0x12345678, 0x12345678, 0x12345678, 0x12345678};

    flip32bytes(test_array, test_array);

    TEST_ASSERT_EQUAL(test_array[0], 0x78563412);
    TEST_ASSERT_EQUAL(test_array[7], 0x78563412);
}